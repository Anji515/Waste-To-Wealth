  ...
  const policies = [
    {
      ...
      sub: [
        { title: "Acts/Rules", description: ["SWM Rules 2016 & amendments"] },
        {
          ...
          description: ["Bulk waste generators pdf by MOHUA",
        ...
        },
        {
          ...
          description: ["Advisory on decentralized composting by MOHUA","Amendment in Guidelines on the Provision of buffer zone around waste processing and disposal facilities issued under SWM Rules, 2016",
    ...
    },
    {
      main: "C and D Waste",
      sub: [
        { title: "Acts/Rules", description: ["C&D waste rules 2016 & amendments"
      ] },
        {
          title: "Policies/Reports",
          description: [
        ...
        {
          title: "Central Guidelines",
          description: ["Guidelines On Environmental Management Of Construction & Demolition (C & D) Wastes",
    ...
    },
    {
      main: "Plastic Waste",
      sub: [
          { title: "Acts/Rules", description: ["Draft Notification on Extended Producer Responsibility (EPR)",
          "Draft Plastic Waste Management Rules, 2022",
          "Implementation of plastic waste rules", "Plastic Waste Management Rules, 2016, as amended, 2021",
          ...
          {
            title: "Central Guidelines",
            description: [  "A Document on Guidelines for Disposal of Thermoset Plastic Waste including Sheet moulding compound (SMC)/Fiber Reinforced Plastic (FRP)",
    ...
    },
    {
      main: "E Waste",
      sub: [
        { title: "Acts/Rules", description: ["E-Waste (Management) Amendment Rules, 2018",
        "E-waste Rules 2016",]},
        {
          title: "Policies/Reports",
          description: ["Business Model Toolbox for Setting up E-Waste Recycling Facility in India",
        ...
        {
          title: "Central Guidelines",
          description: ["Guidelines on Implementation of E-Waste (Management) Rules, 2016 by CPCB"],
        },
      ],
    },
    {
      ...
      sub: [
        { title: "Acts/Rules", description: [  "Bio-medical Waste Management Rules, 2016 (Amended) - 10.05.2019",
        ...
        {
          title: "Central Guidelines",
          description: [  "Guidelines for Handling, Treatment and Disposal of Waste Generated during Treatment/Diagnosis/Quarantine of COVID-19 Patients",
    ...
    },
    {
      ...
      sub: [
        { title: "Acts/Rules", description: ["Hazardous and other Wastes (Management & Transboundary Movement) Amendment Rules, 2017", "Hazardous and other Wastes (Management & Transboundary Movement) Amendment Rules, 2018" , "Hazardous and other Wastes (Management & Transboundary Movement) Amendment Rules, 2019","Hazardous and other Wastes (Management & Transboundary Movement) Rules, 2016" ]},
        {
          title: "Policies/Reports",
          description: ["First Amendments Rules, 06.07.2016",
    ...
    },
    {
      ...
      sub: [
        { title: "Acts/Rules", description: ["G.S.R.221(E), [23/03/2015] - Central Pollution Control Board (Qualifications and Terms and Conditions of Service of Chairman) Rules, 2015", "No.06 of 1974, [23/03/1974] - The Water (Prevention and Control of Pollution) Act, 1974","The Water (Prevention and Control of Pollution) Cess Act, 1977 "
      ]},
        {
          title: "Policies/Reports",
          description: ["National Inventory on Sewage Treatment Plant Report March 2021"],
        },
        {
          title: "Central Guidelines",
          description: ["N.A"],
    ...
    },
    {
      ...
      sub: [
        ...
        {
          title: "Policies/Reports",
          description: ["India Third Biennial Update Report to The United Nations Framework Convention on Climate Change"],
        },
        {
          title: "Central Guidelines",
          description: ["N.A"],
